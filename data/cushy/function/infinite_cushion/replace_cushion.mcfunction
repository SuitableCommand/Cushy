...
$item replace entity @s hotbar.0 with $(id)[minecraft:enchantment_glint_override=true,minecraft:max_stack_size=1,rarity="epic",minecraft:lore=["Why stand when you can sit?"]] 1
